...
# Add MySQL module
module add --name=com.mysql --resources=/opt/jboss/wildfly/custom/mysql-connector-java-5.1.31-bin.jar --dependencies=javax.api,javax.transaction.api
...
# Deploy the WAR
#cp /opt/jboss/wildfly/custom/restAPI.war $JBOSS_HOME/$JBOSS_MODE/deployments/restAPI.war
...
chmod -R 777 /opt/jboss/wildfly/modules/
